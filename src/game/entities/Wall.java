...
public class Wall extends Entity {
	...
	public void render(GameContainer gc, Renderer r) {
		if(tile != null) {
			...
			if(!isDead) {
				if(type != null && imageMap.get(type) != null) r.drawImageTile(imageMap.get(type), (int) spriteX, (int) spriteY, 0, 0);
				...
				if(type != null && imageMap.get(type) != null) r.drawImageTile(imageMap.get(type), (int) spriteX, (int) spriteY, 0, 1);
			}
